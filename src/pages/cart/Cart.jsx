...
const dispatch = useDispatch();
 ...
 const buyNow = async () => {
  ...
  var options = {
    ...
    amount: parseInt(grandTotal * 100), // Convert Rs to paise
    currency: "INR",
    name: "SHOP UP",
    description: "for testing purpose",

    // ✅ This is triggered when the payment is successful
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            ...
            {cartItems.map((item, index) => {
              return (
                <div    key={item.id} className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
